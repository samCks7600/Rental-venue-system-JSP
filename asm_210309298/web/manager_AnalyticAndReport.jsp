        ...
        <div class="row p-5">
            <div class="col text-center">
                <form action="manager_loadAnalytic_BookingListRate" class="row g-4 p-2" method="post">
                    <button type="submit" class="btn btn-secondary">View Booking list & Booking Rate & Income By Venue</button>
                </form>


                <form action="manager_loadAnalytic_memberList" class="row g-4 p-2" method="post">
